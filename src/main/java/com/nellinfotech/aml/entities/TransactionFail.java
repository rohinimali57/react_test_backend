...
@Setter
@Entity
@Table(name = "TransactionFail")
public class TransactionFail extends BaseEntity {
    
    /**
     * 
     */
    private static final long serialVersionUID = -1714182684441395418L;
    
    @Column(name = "CUST_CODE", nullable = true, length = 25)
    ...
    @Column(name = "RULE_EXECUTED", nullable = true, length = 50)
    
    private Integer ruleExecuted;
    
    // Read from Sequence Table
    
    @Column(name = "UPLOAD_COUNT", nullable = true, length = 50)
    
    private Integer uploadCount;
    
    @Column(name = "TXN_NO", nullable = true, length = 50)
    
    private String txnNo = "";
    
    @Column(name = "TXN_CODE", nullable = true, length = 50)
    
    private String txnCode = "";
    
    @Column(name = "TXN_SET_NO", nullable = true, length = 50)
    
    private String txnSetNo = "";
    
    @Column(name = "TXN_SCROLL_NO", nullable = true, length = 50)
    
    private String txnScrollNo = "";
    
    @Column(name = "TXN_TOKEN_NO", nullable = true, length = 50)
    
    private String txnTokenNo = "";
    
    @Column(name = "TXN_BATCH_CODE", nullable = true, length = 50)
    ...
    public String toString() {
        return "TransactionFail [custCode=" + custCode + ", acctNo=" + acctNo + ", ruleExecuted=" + ruleExecuted
                ...
                + ", txnAuthDtTm=" + txnAuthDtTm + ", status=" + status + ", reason=" + reason + ", accountLogId="
                + accountLogId + "]";
    }
